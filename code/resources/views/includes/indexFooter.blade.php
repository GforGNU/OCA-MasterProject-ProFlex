...
<a href="index.html"><img src="{{asset('images/logopng.png')}}" alt=""></a>
...
<div class="col-lg-6 col-md-6">
<div class="copyright">
<i class="far fa-copyright"></i>Copyright 2021 <span>ProFlex</span> by <a href="#">LojainNahhas</a>. All Right Reserved.
</div>
</div>
<div class="col-lg-6 col-md-6">
...
<button onclick="topFunction()" id="pageup" title="Go to top" style="background-color:black; border-color:transparent"><i class="fas fa-arrow-up"></i></button>
...
<!-- Mirrored from gambolthemes.net/html-items/jobby/jobby-freelancer/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Jan 2021 22:00:06 GMT -->
</html>