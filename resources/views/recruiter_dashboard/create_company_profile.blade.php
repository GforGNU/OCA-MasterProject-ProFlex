...
<input name="company_name" type="text" class="job-input" placeholder="Your Company Name">
</div>
</div>
...
<div class="smm_input">
<input name="establishment_date" type="text" class="job-input datepicker-here" data-date-format="yyyy-mm-dd" data-language="en" placeholder="Select Launch Date">
...
<textarea name="profile_description" class="textarea70" placeholder="Describe your experience, skills, etc. In complete details. This is your chance to show off."></textarea>
</div>
</div>
</div>
<div class="col-lg-12">
...
<input name="business_stream" type="text" class="job-input" placeholder="Wordpress Developer">
</div>
</div>
...
<input name="company_website" type="text" class="website-input" placeholder="http://entercompanysite.com/">
